...
<div style="max-width: 600px; width: 100%; padding: 30px;">
    ...
    <h2 style="color: #000000; margin-bottom: 0px; margin-top: 30px; font-style: italic;">{{ __('general.emails.UserRegistered.welcomeTo') }}!</h2>
    <h2 style="color: #ff0000; margin-top: 15px; font-style: italic;">{{ __('general.emails.UserRegistered.description') }}.</h2>
