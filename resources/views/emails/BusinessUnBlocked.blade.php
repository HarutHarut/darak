...
<div style="max-width: 600px; width: 100%; padding: 30px;">
    ...
    <h2 style="color: #ff0000; margin-top: 15px;">{{ __('general.emails.your') }} {{ $business->name['en'] }} {{ __('general.emails.BusinessUnBlocked.businessUnblocked') }}.</h2>
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td>{{ $business->address }}
{{--                <a href="{{ 'https://www.google.ru/maps/@' . $business->lat . ',' . $business->lng . ',10z' }}" style="display: block; color: #40c4f4; text-decoration: none; margin-top: 4px;">{{ __('general.emails.googleMaps') }}</a>--}}
            </td>
        </tr>
        <tr>
