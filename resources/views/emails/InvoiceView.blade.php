...
<div style="max-width: 600px; width: 100%; padding: 30px;">
    ...
    <h2 style="color: #000000; margin-bottom: 0px; margin-top: 30px; font-style: italic;">{{ __('general.emails.dear') . ' ' . $businessUser->name }},</h2>
    <h2 style="color: #ff0000; margin-top: 15px;">{{ __('general.emails.invoice.weWouldLike') }}.</h2>
    <h2>{{ __('general.emails.invoice.pleaseSeeAttachedFile') }}.</h2>
