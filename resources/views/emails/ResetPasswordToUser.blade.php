...
<div style="max-width: 600px; width: 100%; padding: 30px;">
    ...
    <h2 style="font-style: italic;">{{ __('general.emails.ResetPasswordToUser.passwordHasBeenReset') }}: {{ $newPassword }}</h2>

    <a target="_blank" href="{{ config('app.url') . '#login' }}" class="cancel-booking-btn">
        {{ __('general.emails.login') }}
    </a>
